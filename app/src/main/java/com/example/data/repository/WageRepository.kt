...
class WageRepository(
    ...
    suspend fun getTotalWageForEmployee(employeeId: Long): Double = wageRecordDao.getTotalWageForEmployee(employeeId)

    suspend fun getTotalWagesInRange(startDate: Long, endDate: Long): Double = wageRecordDao.getTotalWagesInRange(startDate, endDate)

    suspend fun getTotalWagesAll(): Double = wageRecordDao.getTotalWagesAll()
